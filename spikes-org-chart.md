...
graph TD
    ...
    subgraph SG_PROMO ["集客"]
      ...
      ArugaP --> TagamiP[田上 睦己]
      ArugaP --> NishikawaP[西川 歩花]
      ArugaP --> SaitoP[齋藤 杏理]
      ArugaP --> AzumadaP[東田 蒼人]
      ArugaP --> YamashitaP[山下 翼]
      ArugaP --> ShimakawaP[島川 哲也]
      ArugaP --> UjiP[宇治 大輝]
      ArugaP --> KawaiP[川合 正宗]
      ArugaP --> MuraseP[村瀬 智哉]
      KatoP --> TagamiP
      KatoP --> NishikawaP
      KatoP --> SaitoP
      KatoP --> AzumadaP
    ...
    class SNS,DATA,EV,LP,GUILD,NOMAD,CREATIVE,PITCH,STAGE,SPIKATHON,NW,SQUARE,BLITZ,ROUND,MARKET,POPUP,RECRUIT,HAIBATSU role;
    class Aruga2,Tagami2,Tatsuzaki2,Ozawa2,Yamashita2,Shimakawa2,Shimakawa3,Kishida2,Shiratori2,Inoue2,Udatsu2,Saito2,Matsuo2,Matsuo3,Kato2,Sakamoto2,Nishikawa2,Kurenai2,Kurenai3,Yamada2,Onoda2,Onoda3,Uji2,Kawai2,Murase2,ArugaP,KatoP,TagamiP,NishikawaP,SaitoP,AzumadaP,YamashitaP,ShimakawaP,UjiP,KawaiP,MuraseP person;
```
